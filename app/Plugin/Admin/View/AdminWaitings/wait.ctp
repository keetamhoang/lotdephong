            ...
            <div class="each">
                ...
                <div class="col-lg-10">
                    <div class="event">
                        <?= $this->Html->link(
                            $post['Event']['name'],
                            array('plugin' => 'admin', 'controller' => 'AdminEvents', 'action' => 'censorship', $post['Event']['id'])
                        ) ?>
                    </div>
                    <div class="date">
                ...
                <div class="col-lg-2">
                    <div class="actions">
                        ...
                        <?= $this->Html->link(
                            ...
                            array('plugin' => 'admin', 'controller' => 'posts', 'action' => 'add', $post['Event']['id']),
